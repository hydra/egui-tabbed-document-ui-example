                ...
                .add(|tui| {
                    ...
                    .add(|tui| {
                        ...
                        tui.style(Style { ..default_style() })
                            .add(|tui| tui.label(tr!("form-new-directory")));
...
impl NewTab {
    fn on_submit(&mut self, tab_key: &TabKey, sender: &AppMessageSender) {
        ...
        sender
            .send((
                MessageSource::Tab(tab_key.clone()),
                AppMessage::CreateDocument(args),
            ))
            .unwrap()
    }
